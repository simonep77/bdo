...
namespace Tact.Reflection
{
    public sealed class EfficientInvoker
    {
        ...
        public static EfficientInvoker ForMethod(Type type, MethodInfo method)
        {
            ...
            var key = new MethodKey(type, method.Name);
        ...
        /// <summary>
        /// Crea un invoker senza gestione della cache interna
        /// </summary>
        /// <param name="type"></param>
        /// <param name="method"></param>
        /// <returns></returns>
        public static EfficientInvoker ForMethodNoCached(Type type, MethodInfo method)
        {
            if (type == null)
                throw new ArgumentNullException(nameof(type));
