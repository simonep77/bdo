...
namespace Business.Data.Objects.Common.Logging
{
    /// <summary>
    ...
    public abstract class LoggerBase: IDisposable   
    {
        ...
        public static string FormatLogTextException(string dateFromat, bool writeThreadId, Exception e, bool includeStack)
        {
            ...
            sb.AppendLine(string.Concat(sDate, sThread, @" - ", Constants.LOG_SEPARATOR));
            ...
            sb.Append(string.Concat(sDate, sThread, @" - ", Constants.LOG_SEPARATOR));
